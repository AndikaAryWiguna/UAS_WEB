                ...
                <ul class="nav side-menu">
                  <li><a href="#"><i class="fa fa-desktop"></i> Data Mahasiswa <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="user.php?page=tampil_mhs">Tampil Data</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-desktop"></i> Data Pegawai <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="datadosen.php">Tampil Data</a></li>
                    </ul>
              </div>
            </div>
            <!-- /sidebar menu -->
